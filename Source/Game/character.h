...
public:
	...
	void characterKeyDown(UINT nChar, backgroundTool *background);
	...
	MyCMovingBitmap *getPopUpFlagAddress();
...
protected:
	...
	MyCMovingBitmap popUp; // pop up image after died 
